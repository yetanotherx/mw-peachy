...
require_once( $pgIP . 'Includes/Diff/textdiff/Diff.php' );
require_once( $pgIP . 'Includes/Diff/textdiff/Diff/Renderer.php' );
...
function getTextDiff($method, $diff1, $diff2) {
	...
	switch ($method) {
		case 'unified':
			require_once $pgIP . 'Includes/Diff/textdiff/Diff/Renderer/unified.php';
			...
			break;
		case 'inline':
			require_once $pgIP . 'Includes/Diff/textdiff/Diff/Renderer/inline.php';
			$diff = new Text_Diff('auto', array(explode("\n",$diff1), explode("\n",$diff2)));
			...
			break;
		case 'context':
			require_once $pgIP . 'Includes/Diff/textdiff/Diff/Renderer/context.php';
			$diff = new Text_Diff('auto', array(explode("\n",$diff1), explode("\n",$diff2)));
